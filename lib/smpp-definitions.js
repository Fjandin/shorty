...
exports.command_status = {
	...
	ESME_INVALID_SERVICE:	{ value: 0x00000553, description: "Invalid Service Request" }
};
...
exports.command_status_codes = {
	...
	0x00000553: "ESME_INVALID_SERVICE"
};
...
exports.command_formats = {
    ...
    submit_sm : {
        ...
        body : [
            ...
            { name: "source_addr_npi", type: "int", bytes: 1, default: 1 },
            { name: "source_addr", type: "c-string", min: 1, max: 21 },
            { name: "dest_addr_ton", type: "int", bytes: 1, default: 1 },
            { name: "dest_addr_npi", type: "int", bytes: 1, default: 1 },
